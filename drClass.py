...
class drClass:
    ...
    def parseRunstring(self, parser=None, argparse=None):
        ...
        parser.add_argument('-k', '--droneKmPerHr', help='drone speed Km/h, default 60Km/hr', metavar='n', type=float, default=60.0)
        ...
        parser.add_argument('-t', '--droneType', help='type of drone - currently ehang184 or ehang184x, default ehang184', metavar='ehang184', default="ehang184")
