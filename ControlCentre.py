...
class ControlCentre:
    ...
    def __init__(self,wEnergy,wUrgency,proximityRadius,maxDrones,dronePrint,droneLog,chargePrint,chargeLog):
        ...
        self.droneLog = droneLog
        self.chargePrint = chargePrint
        self.chargeLog = chargeLog
    ...
    def calcUrgency(self):
        ...
        if len(self.requests) == 1:
          for ev in self.requests:
            ...
            firstCall = True
            for ev in sorted(self.requests):    # not sure i need to sort
       ...
       # print("lenset",len(set(self.freeDrones | self.needChargeDrones | set(self.allocatedDrone))))
        ...
        if brief:
            ...
            print("{}\t{!r}\t{!r}\t{!r}\t{:.1f}\t{:.1f}\t{:.0f}\t{:.1f}".format\
              ...
              GG.ss.dronePrint,self.wEnergy,self.wUrgency,self.proximityRadius,GG.ss.timeStep), end='')
            ...
            print("\tModel flags:\tRendezvous: {!r}\tCharge Once: {!r}\tDrone print: {!r}\n\tEnergy Weight: "
                  ...
                  (GG.ss.modelRendezvous,GG.ss.onlyChargeOnce,GG.ss.dronePrint,self.wEnergy,
